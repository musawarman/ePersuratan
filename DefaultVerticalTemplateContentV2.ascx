<%@ Control Language="C#" CodeBehind="DefaultVerticalTemplateContentV2.ascx.cs" ClassName="DefaultVerticalTemplateContentV2" Inherits="RGN.EPERSURATAN.APPS.Web.DefaultVerticalTemplateContentV2" %>
...
<dx:ASPxHiddenField ID="ClientParams" runat="server" ClientInstanceName="ClientParams">
</dx:ASPxHiddenField>
...
<div class="white borderBottom width100" id="headerTableDiv">
    <div class="paddings <%= AdditionalClass %>" style="margin: auto">
        ...
        <p style="margin-top: -10px; font-weight: bold; font-size: 10px;"><span>Selamat datang, Yth : </span><span runat="server" id="userAbbrevation">...</span> - <span id="userFullName" runat="server">...</span></p>
    </div>
</div>
<div id="mainDiv" class="xafAlignCenter paddings overflo    wHidden <%= AdditionalClass %>">
                                        ...
                                        <td>
                                            <xaf:XafUpdatePanel ID="XafUpdatePanel1" runat="server">
                                                <xaf:ActionContainerHolder runat="server" ID="mainMenu" ContainerStyle="Buttons" Orientation="Horizontal">
                                                    <menu width="100%" itemautowidth="False" clientinstancename="mainMenu" font-size="14px" enableadaptivity="true" itemwrap="false">
