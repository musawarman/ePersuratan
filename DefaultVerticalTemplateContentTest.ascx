<%@ Control Language="C#" CodeBehind="DefaultVerticalTemplateContentTest.ascx.cs" ClassName="DefaultVerticalTemplateContentTest" Inherits="RGN.EPERSURATAN.APPS.Web.DefaultVerticalTemplateContentTest" %>
                                ...
                                <td id="LPcell" style="width: 200px; vertical-align: top">
                                    <div id="LP" class="LeftPane">
                                        ...
                                        <cc2:NavigationActionContainer ID="NC" runat="server" CssClass="xafNavigationBarActionContainer"
                                            ContainerId="ViewsNavigation" Width="200px" />
                                        </cc3:XafUpdatePanel>
