<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebSuratDinasUserControl.ascx.cs" Inherits="RGN.EPERSURATAN.APPS.Web.Controls.SuratDinas.WebSuratDinasUserControl" %>
...
<dx:ASPxRichEdit ID="ASPxRichEdit1" runat="server" Height="700px" Width="100%" WorkDirectory="~\App_Data\WorkDirectory" EnableClientSideAPI="True" ClientInstanceName="richEdit" AutoSaveMode="On" Theme="Office2010Black" AutoSaveTimeout="00:01:00" EnableTheming="True">
    <RibbonTabs>
        <dx:RERFileTab>
            <Groups>
