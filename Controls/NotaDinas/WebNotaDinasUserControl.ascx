<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebNotaDinasUserControl.ascx.cs" Inherits="RGN.EPERSURATAN.APPS.Web.Controls.NotaDinas.WebNotaDinasUserControl" %>

<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>

<%@ Register assembly="DevExpress.Web.ASPxRichEdit.v15.2, Version=15.2.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web.ASPxRichEdit" tagprefix="dx" %>

<dx:ASPxRichEdit ID="ASPxRichEdit1" runat="server" Height="700px" Width="100%" WorkDirectory="~\App_Data\WorkDirectory" EnableClientSideAPI="True" ClientInstanceName="richEdit" AutoSaveMode="On" Theme="Office2010Black" AutoSaveTimeout="00:03:00" EnableTheming="True" OnPreRender="DemoRichEdit_PreRender">
